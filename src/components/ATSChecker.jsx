  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-4 bg-white">
        ...
        <div className="mt-10 flex flex-row w-full justify-between items-start flex-wrap gap-6">
          ...
          {atsScore && (
            <div className="flex-1 p-4 border rounded-lg w-full max-w-3xl bg-gray-50">
